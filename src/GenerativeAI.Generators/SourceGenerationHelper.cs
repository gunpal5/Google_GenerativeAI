...
{@interface.Methods.Select((method, i) => $@"
            ...
            return new global::System.Collections.Generic.List<global::GenerativeAI.Tools.ChatCompletionFunction>
            {{
{@interface.Methods.Select((_, i) => $@"
                new global::GenerativeAI.Tools.ChatCompletionFunction()
                {{
                    Name = function{i}.Name,
                    Description = function{i}.Description,
                    Parameters = new global::GenerativeAI.Tools.ChatCompletionFunctionParameters
                    {{
